...
void StateEstimator::initialPose() {
    if (!fixedInitialPose_) {
        ...
        initialPose_.orientation.w = odom_msg_.pose.pose.orientation.w;
        initialPose_.orientation.x = odom_msg_.pose.pose.orientation.x;
        initialPose_.orientation.y = odom_msg_.pose.pose.orientation.y;
        initialPose_.orientation.z = odom_msg_.pose.pose.orientation.z;
